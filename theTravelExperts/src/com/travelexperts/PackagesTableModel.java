...
import javax.swing.table.AbstractTableModel;
	...
	// copied from Default Table Model only changed a lit bit
		public class PackagesTableModel extends AbstractTableModel implements Serializable {
			...
			//
			    ...
			    /**
			     *  Constructs a <code>AgentTableModel</code> with
			     ...
			     * @see #setValueAt
			     */
			    public PackagesTableModel(int rowCount, int columnCount) {
			        this(newVector(columnCount), rowCount); 
			    }

			    /**
			     *  Constructs a <code>AgentTableModel</code> with as many columns
			     ...
			     * @see #setValueAt
			     */
			    public PackagesTableModel(Vector columnNames, int rowCount) {
			        setDataVector(newVector(rowCount), columnNames);
			    }

			    /**
			     *  Constructs a <code>AgentTableModel</code> with as many
			     ...
			     * @see #setValueAt
			     */
			    public PackagesTableModel(Object[] columnNames, int rowCount) {
			        this(convertToVector(columnNames), rowCount);
			    }

			    /**
			     *  Constructs a <code>PackagesTableModel</code> and initializes the table
			     ...
			     * @see #setDataVector
			     */
			    public PackagesTableModel(Vector data, Vector columnNames) {
			     ...
			     * @see #setDataVector
			     */
			    public PackagesTableModel(Object[][] data, Object[] columnNames) {
			        setDataVector(data, columnNames);
			    }
			...
			// 
				...
				// Sometimes the PackagesTableModel is subclassed 
